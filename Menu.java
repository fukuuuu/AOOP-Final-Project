...
//      
        ...
        try {
            PreparedStatement st = DBConnection.connectDB("eventdb").prepareStatement("UPDATE eventdetails SET members='" + together + "'  WHERE event = '" + selectedEvent + "' ");
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            PreparedStatement st = DBConnection.connectDB("eventdb").prepareStatement("DELETE from eventdetails WHERE event = '" + selectedEvent + "' ");
    ...
    private void leaveButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            PreparedStatement st = DBConnection.connectDB("eventdb").prepareStatement("UPDATE eventdetails SET members='" + updated_mem + "'  WHERE event = '" + selectedEvent + "' ");
